const getRandom = (min, max) => {
  ...
  class Universe {
    ...
    start () {
      ...
      //     clientX: Math.random() * this.el.width,
      //     clientY: Math.random() * this.el.height,
      //   })
      // },3000)
    }
    stop () {
    ...
    updateSize () {
      ...
      this.el.width = this.width = this.el.style.width
      this.el.height = this.height = this.el.style.height
